...
- [x] Set up folder structure (src/app, components, server, lib, hooks, types)
- [x] Install core dependencies (@supabase/supabase-js, @tanstack/react-query, zustand, zod, lucide-react)
- [x] Install build dependencies (sharp, stripe, openai, @aws-sdk/client-s3)
...
- [x] Set up globals.css with color variables
