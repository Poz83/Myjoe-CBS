...
>(({ className, children, size = 'md', ...props }, ref) => {
  ...
  return (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex w-full items-center justify-between whitespace-nowrap rounded-lg",
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDown className="h-4 w-4 text-text-muted ml-2 shrink-0" />
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-lg border border-border-default bg-bg-elevated text-text-primary shadow-lg",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "data-[state=checked]:bg-selected-bg data-[state=checked]:text-accent-cyan",
